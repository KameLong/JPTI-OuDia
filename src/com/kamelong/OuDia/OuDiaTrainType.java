...
public class OuDiaTrainType {
     ...
     * ダイヤグラム線色
     */
    protected Color diaColor=Color.BLACK;
    /**
     * ダイヤグラムを太線で描画するか
     */
    ...
    public StringBuilder makeTrainTypeText(){
        ...
        result.append("\r\nJikokuhyouMojiColor=").append(OuDiaFile.color2OudiaString(textColor));
        result.append("\r\nDiagramSenColor=").append(OuDiaFile.color2OudiaString(diaColor));
        switch (lineStyle){
